...
export default function EditarChollo() {
  ...
  useEffect(() => {
    ...
    api.chollos
      ...
      .then((res) => {
        ...
        // compruebo si el usuario es el autor
      ...
      .catch(() => setErrorCarga("No se pudo cargar el chollo. Comprueba la conexión con el servidor."))
  ...
  const validar = () => {
    ...
    if (
      form.precioOferta && form.precioOriginal &&
  ...
  const imagenPreview =
    form.imagen.trim() || "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=600";
        ...
        <Grid item xs={12} lg={7}>
          <Stack spacing={2.5}>
            <Paper elevation={2} sx={{ p: 3, borderRadius: 3 }}>
              ...
              <Stack spacing={2.5}>
                <TextField
                  fullWidth label="Título del chollo *"
                  value={form.titulo} onChange={cambiar("titulo")}
                ...
                <TextField
                  ...
                  value={form.descripcion} onChange={cambiar("descripcion")}
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
                  ...
                  <FormControl fullWidth error={!!errores.ciudad}>
                    ...
                    <Select
                      value={form.ciudad} onChange={cambiar("ciudad")} label="Provincia *"
                      renderValue={(v) => v} MenuProps={{ PaperProps: { sx: { maxHeight: 300 } } }}
                    >
              ...
              <Stack spacing={2.5}>
                <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
                  <TextField
                    ...
                    value={form.tienda} onChange={cambiar("tienda")}
                  ...
                  <TextField
                    ...
                    value={form.enlace} onChange={cambiar("enlace")}
                    placeholder="https://..."
                ...
                <TextField
                  ...
                  value={form.imagen} onChange={cambiar("imagen")}
            ...
            <Paper elevation={2} sx={{ borderRadius: 3, overflow: "hidden" }}>
              ...
              <Box sx={{ p: 3 }}>
                <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap sx={{ mb: 2 }}>
                  {form.categoria && (
                    <Chip icon={<LocalOfferIcon />} label={form.categoria} size="small" color="error" variant="outlined" />
                  )}
                  {form.ciudad && <Chip label={`📍 ${form.ciudad}`} size="small" variant="outlined" />}
                  {descuento !== null && descuento > 0 && (
                    <Chip label={`-${descuento}%`} size="small" color="success" sx={{ fontWeight: "bold" }} />
                  )}
                </Stack>
