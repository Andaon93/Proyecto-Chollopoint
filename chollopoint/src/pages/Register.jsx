  ...
  return (
    ...
    >
      <Container maxWidth="sm">
        <Paper
          elevation={10}
          sx={{ p: 5, borderRadius: 4, boxShadow: "0px 10px 30px rgba(0,0,0,0.15)" }}
        >
          {/* Cabecera */}
          <Box sx={{ textAlign: "center", mb: 3 }}>
            ...
            <Typography color="text.secondary">
              Únete a la comunidad de cazachollos
            </Typography>
          </Box>
          ...
          <Box component="form" onSubmit={handleSubmit}>
            ...
            {password && (
              <Box sx={{ mt: 0.5, mb: 1 }}>
                ...
                />
                <Typography variant="caption" color={`${fuerza.color}.main`}>
            ...
            <TextField
              ...
              InputProps={{
                ...
                endAdornment: (
                  <InputAdornment position="end">
                    <IconButton onClick={() => setVerConfirmar(!verConfirmar)} edge="end">
                      {verConfirmar ? <VisibilityOffIcon /> : <VisibilityIcon />}
                    </IconButton>
                  </InputAdornment>
                ),
              }}
          ...
          <Typography align="center" color="text.secondary">
            ¿Ya tienes cuenta?{" "}
            <Link to="/login" style={{ color: "#e53935", fontWeight: "bold" }}>
              Iniciar sesión
            </Link>
          </Typography>
        </Paper>
