...
//  al formato camelCase que usan los componentes React.
// ============================================================
...
export const normalizeChollo = (c) => ({
  ...
  // campos extra que devuelve el JOIN con usuarios
  ...
  // Serán null si el usuario no introdujo dirección al publicar
  latitud:          c.latitud  != null ? parseFloat(c.latitud)  : null,
  longitud:         c.longitud != null ? parseFloat(c.longitud) : null,
